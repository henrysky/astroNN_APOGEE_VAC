...
# sanity check
if not np.all(xmatched_allcolumns['source_id'] == allstar_data['GAIAEDR3_SOURCE_ID'][gaia_matched_idx]):
...
col = [fits.Column(name='APOGEE_ID', array=allstar_data['APOGEE_ID'], format="18A"),
       ...
       fits.Column(name='astrometric_n_good_obs_al', array=astrometric_n_good_obs_al, format='I'),
       ...
       fits.Column(name='nu_eff_used_in_astrometry', array=nu_eff_used_in_astrometry, format='E'),
       fits.Column(name='astrometric_params_solved', array=astrometric_params_solved, format='I'),
       ...
       fits.Column(name='ipd_gof_harmonic_amplitude', array=ipd_gof_harmonic_amplitude, format='E'),
       fits.Column(name='ipd_frac_multi_peak', array=ipd_frac_multi_peak, format='I'),
       fits.Column(name='phot_bp_rp_excess_factor', array=phot_bp_rp_excess_factor, format='E'),
       # new in DR3
       ...
       fits.Column(name='distance_gspphot_lower', array=distance_gspphot_lower, format='E'),
       fits.Column(name='distance_gspphot_upper', array=distance_gspphot_upper, format='E'),
       ...
       fits.Column(name='ebpminrp_gspphot_lower', array=ebpminrp_gspphot_lower, format='E'),
       fits.Column(name='ebpminrp_gspphot_upper', array=ebpminrp_gspphot_upper, format='E'),

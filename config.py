...
gaia_allcolumns_f = "apogeedr17_syncspec_gaiaedr3_xmatch_allcolumns.fits"
# file name for gaia selected columns but row matched to allstar, can be a path if file is not stored in current dir
gaia_rowmatch_f = "apogeedr17_syncspec_gaiaedr3_xmatch.fits"
...
astronn_dist_f = "apogee_dr17_synspe_edr3_nn_dist.fits"
...
astronn_apogee_vac_f = "apogee_astroNN-DR17_syncspec_edr3.fits"